...
def test_simple_agent_full_investigation():
    ...
    print("    - download_buyer_attachment: Download attachments")
    print("    - read_buyer_attachment_doc: Extract text with OCR")
    ...
    print("  - download_buyer_attachment: Downloads files for analysis")
    print("  - read_buyer_attachment_doc: Extracts text with Mistral OCR")
    print("\n✓ Analysis Features:")
